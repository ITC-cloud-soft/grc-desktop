-- 034_metacoder_tool_guide.sql
-- Append MetaCoder tool guidance to dev-related role templates
-- (engineering-lead, game-designer, godot-*, ai-engineer, etc.)
--
-- MetaCoder is the heavy-duty development tool inside WinClaw Docker containers,
-- backed by semantic knowledge graphs and multi-agent TDD. This migration
-- appends a "MetaCoder Tool" section to tools_md for 31 development-focused roles.

SET NAMES utf8mb4;
SET CHARACTER SET utf8mb4;

UPDATE `role_templates`
SET `tools_md` = CONCAT(`tools_md`, '\n\n## 🧠 MetaCoder Tool (Heavy Development)
...
-- Also append a brief reference in agents_md so the role itself knows about the tool
UPDATE `role_templates`
SET `agents_md` = CONCAT(`agents_md`, '\n\n## 🧠 Heavy Development: MetaCoder
